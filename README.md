...
|   CA   |  CVPR 2021  |                       | Coordinate Attention for Efficient Mobile Network Design     | [url](https://openaccess.thecvf.com/content/CVPR2021/html/Hou_Coordinate_Attention_for_Efficient_Mobile_Network_Design_CVPR_2021_paper.html) |
| FcaNet |  ICCV 2021  |                       | FcaNet: Frequency Channel Attention Networks                 | [url](https://openaccess.thecvf.com/content/ICCV2021/html/Qin_FcaNet_Frequency_Channel_Attention_Networks_ICCV_2021_paper.html) |
| SA-Net | ICASSP 2021 |                       | SA-Net: Shuffle Attention for Deep Convolutional Neural Networks | [url](https://ieeexplore.ieee.org/abstract/document/9414568) |
| SimAM  |  PMLR 2021  | 无参注意力            | SimAM: A Simple, Parameter-Free Attention Module for Convolutional Neural Networks |      [url](https://proceedings.mlr.press/v139/yang21o)       |
|        |             |                       |                                                              |                                                              |
|  CGA   |  CVPR 2023  |                       | EfficientViT: Memory Efficient Vision Transformer With Cascaded Group Attention | [url](https://openaccess.thecvf.com/content/CVPR2023/html/Liu_EfficientViT_Memory_Efficient_Vision_Transformer_With_Cascaded_Group_Attention_CVPR_2023_paper.html) |
|        |             |                       |                                                              |                                                              |
|        |             |                       |                                                              |                                                              |
...
| 模块 | 期刊/会议 | 简单描述                                                     | 论文标题                                                     |                           论文地址                           |
| :--: | :-------: | :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------: |
| SMFA | ECCV 2024 | 特征融合模块，适用于高分辨率图像恢复，暗光增强，小目标分割，小目标检测等所有CV任务通用模块 | SMFANet: A Lightweight Self-Modulation Feature Aggregation Network for Efficient Image Super-Resolution | [url](https://link.springer.com/chapter/10.1007/978-3-031-72973-7_21) |
...
|   模块   | 期刊/会议 | 简单描述 | 论文标题                                   |                           论文地址                           |
| :------: | :-------: | :------- | :----------------------------------------- | :----------------------------------------------------------: |
| DySample | ICCV 2023 |          | Learning to Upsample by Learning to Sample | https://openaccess.thecvf.com/content/ICCV2023/html/Liu_Learning_to_Upsample_by_Learning_to_Sample_ICCV_2023_paper.html |
...
|      PSFM      |                 Information Fusion 2023                  |                                          | Rethinking the necessity of image fusion in high-level vision tasks: A practical infrared and visible image fusion network based on progressive semantic injection and scene fidelity | https://www.sciencedirect.com/science/article/abs/pii/S1566253523001860 |
|                |                                                          |                                          |                                                              |                                                              |
...
|                |                                                          |                                          |                                                              |                                                              |
|                |                                                          |                                          |                                                              |                                                              |
|      LSK       |                        ICCV 2023                         |                                          | Large Selective Kernel Network for Remote Sensing Object Detection | https://openaccess.thecvf.com/content/ICCV2023/html/Li_Large_Selective_Kernel_Network_for_Remote_Sensing_Object_Detection_ICCV_2023_paper.html |
|                |                                                          |                                          |                                                              |                                                              |
|                |                                                          |                                          |                                                              |                                                              |
|                |                                                          |                                          |                                                              |                                                              |
...
|      FCA       |                   Neural Networks 2024                   |   增强局部和全局特征信息交互——图像去雾   | Unsupervised Bidirectional Contrastive Reconstruction and Adaptive Fine-Grained Channel Attention Networks for image dehazing | https://www.sciencedirect.com/science/article/abs/pii/S0893608024002387 |
|      CAFM      |     IEEE Geoscience and Remote Sensing Letters 2024      |                                          | Hybrid Convolutional and Attention Network for Hyperspectral Image Denoising |    https://ieeexplore.ieee.org/abstract/document/10445289    |
|      MFII      |               Medical Image Analysis 2024                | 双分支信息交互提取图像特征模块——图像分割 | I²U-Net: A dual-path U-Net with rich information interaction for medical image segmentation | https://www.sciencedirect.com/science/article/abs/pii/S136184152400166X |
...
|      CCFF      |                        CVPR 2024                         |                                          |        DETRs Beat YOLOs on Real-time Object Detection        | https://openaccess.thecvf.com/content/CVPR2024/html/Zhao_DETRs_Beat_YOLOs_on_Real-time_Object_Detection_CVPR_2024_paper.html |
|      MLKA      |                        CVPR 2024                         |                                          | Multi-scale Attention Network for Single Image Super-Resolution | https://openaccess.thecvf.com/content/CVPR2024W/NTIRE/html/Wang_Multi-scale_Attention_Network_for_Single_Image_Super-Resolution_CVPRW_2024_paper.html |
...
|                |                                 |                             |                                                              |                                                              |
|     LDConv     | Image and Vision Computing 2024 | 线性可变形卷积 目标检测任务 | LDConv: Linear deformable convolution for improving convolutional neural networks | https://www.sciencedirect.com/science/article/abs/pii/S0262885624002956 |
|                |                                 |                             |                                                              |                                                              |
